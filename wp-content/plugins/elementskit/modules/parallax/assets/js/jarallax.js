...
! function(e) {
    ...
    (function(e) {
        ...
        function g(e) {
            d = l.window.innerWidth || document.documentElement.clientWidth, p = l.window.innerHeight || document.documentElement.clientHeight, "object" !== (void 0 === e ? "undefined" : i(e)) || "load" !== e.type && "dom-loaded" !== e.type || (f = !0)
        }
        g(), l.window.addEventListener("resize", g), l.window.addEventListener("orientationchange", g), l.window.addEventListener("load", g), (0, a["default"])((function() {
            g({
                type: "dom-loaded"
            })
        }));
        ...
        function h() {
            if (b.length) {
                ...
                var e = f || !v || v.width !== d || v.height !== p,
                    t = y || e || !v || v.y !== m;
                y = f = !1, (e || t) && (b.forEach((function(o) {
        ...
        var x = !!e.ResizeObserver && new e.ResizeObserver((function(e) {
                e && e.length && (0, r["default"])((function() {
            ...
            $ = function() {
                function e(t, o) {
                    ...
                    var n = this;
                    n.instanceID = w++, n.$item = t, n.defaults = {
                        type: "scroll",
                        speed: .5,
                        imgSrc: null,
                    ...
                    if (Object.keys(l).forEach((function(e) {
                        ...
                        })), n.options = n.extend({}, n.defaults, r, s, o), n.pureOptions = n.extend({}, n.options), Object.keys(n.options).forEach((function(e) {
                    ...
                    d && "object" === (void 0 === d ? "undefined" : i(d)) && void 0 !== d.length && (d = function(e, t) {
                    ...
                    }(d, 1)[0]), d instanceof Element || (d = null), n.options.elementInViewport = d, n.image = {
                ...
                return n(e, [{
                    key: "css",
                    value: function(e, t) {
                        return "string" == typeof t ? l.window.getComputedStyle(e).getPropertyValue(t) : (t.transform && u && (t[u] = t.transform), Object.keys(t).forEach((function(o) {
                            e.style[o] = t[o]
                        })), e)
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        o.position = e.image.position, e.css(e.image.$item, o), e.image.$container.appendChild(e.image.$item), e.onResize(), e.onScroll(!0), e.options.automaticResize && x && x.observe(e.$item), e.options.onInit && e.options.onInit.call(e), "none" !== e.css(e.$item, "background-image") && e.css(e.$item, {
                    ...
                    value: function() {
                        var e, t = this,
                            ...
                            r = 0,
                            l = n;
                        return a && (i < 0 ? (r = i * Math.max(n, p), p < n && (r -= i * (n - p))) : r = i * (n + p), 1 < i ? l = Math.abs(r - p) : i < 0 ? l = r / i + Math.abs(r) : l += (p - n) * (1 - i), r /= 2), t.parallaxScrollDistance = r, e = a ? (p - l) / 2 : (n - l) / 2, t.css(t.image.$item, {
                            height: l + "px",
                            marginTop: e + "px",
                    ...
                    value: function(e) {
                        var t = this,
                            ...
                            a = {},
                            r = o;
                        if (t.options.elementInViewport && (r = t.options.elementInViewport.getBoundingClientRect()), t.isElementInViewport = 0 <= r.bottom && 0 <= r.right && r.top <= p && r.left <= d, e || t.isElementInViewport) {
                            var l = Math.max(0, n),
                                s = Math.max(0, i + n),
                                c = Math.max(0, -n),
                                u = Math.max(0, n + i - p),
            ...
            j = function(e) {
                ("object" === ("undefined" == typeof HTMLElement ? "undefined" : i(HTMLElement)) ? e instanceof HTMLElement : e && "object" === (void 0 === e ? "undefined" : i(e)) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName) && (e = [e]);
                for (var t = arguments[1], o = Array.prototype.slice.call(arguments, 2), n = e.length, a = 0, r = void 0; a < n; a++)
                    if ("object" === (void 0 === t ? "undefined" : i(t)) || void 0 === t ? e[a].jarallax || (e[a].jarallax = new $(e[a], t)) : e[a].jarallax && (r = e[a].jarallax[t].apply(e[a].jarallax, o)), void 0 !== r) return r;
                return e
            };
